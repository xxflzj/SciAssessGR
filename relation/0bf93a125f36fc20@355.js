...
{
  const links = await FileAttachment("field_relation@3.csv").csv({typed: true});
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["field_relation@3.csv", {url: new URL("./files/fd79d8a685e986526f60415d03a71d70688f2f255a667cd188d5e5784b2aca0c5565f75f82030235534a9e282c49650854c714bfa4ed8685ec959b43cad91e72.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
